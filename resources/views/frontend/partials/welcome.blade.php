                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="caption element text-left visible-mob" data-stellar-ratio="0.95">
                                <h2><span>100% Natural</span><span>  Coconut Water</span></h2>
                                ...
                                <a href="products.html" class="btn btn-default">VIEW DETAILS <i class="fa fa-long-arrow-right"></i></a>
        ...
        <section class="featured-collection no-padding-top">
            <div class="container">
                ...
                <div class="col-md-5">
                        ...
                        <h2>Cocosmile น้ำมะพร้าวแท้ 100%  ให้คุณดูแลตัวเองง่ายๆได้ทุกวัน</h2>
                        <p>น้ำมะพร้าวเป็นอาหารบริสุทธิ์ ดื่มได้ทุกวัน ทุกเพศทุกวัย เพราะเป็นเครื่องดื่มจากธรรมชาติ ทำให้ร่างกายสดชื่นและเต็มไปด้วยกลูโคสที่ร่างกายดูดซึมเข้าไปใช้ได้ง่ายๆ</p>
                        <a href="products.html" class="btn btn-default">VIEW OUR PRODUCTS <i class="fa fa-long-arrow-right"></i></a>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 align-vertical">
                        <a href="contact.html" class="btn btn-primary">CONTACT US <i class="fa fa-long-arrow-right"></i></a>
                    </div>
                </div><!-- END Row -->
            </div><!-- END Container -->
        </section>
